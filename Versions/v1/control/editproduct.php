			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					...
					<div class="radio-inline">
						<label><input type="radio" 
						<?php
						if ($user->display_product('status') == 'featured')
						{
							echo "checked";
						}
						?>
						 value="featured" name="status"> Featured </label>
					</div>
					<div class="radio-inline">
						<label><input type="radio"
						<?php
						if ($user->display_product('status') == 'top-featured')
						{
							echo "checked";
						}
						?>
						 name="status" value="top-featured"> Top featured </label>
					</div>
				</div>
			</div>
			<div class="form-group">
